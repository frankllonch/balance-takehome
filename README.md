...
| [`BRIEF.md`](BRIEF.md) | el enunciado original (dado) |

Estado: las cuatro fases del enunciado están construidas, con CLI y 93 tests.
...
tests/                   93 tests · capas 0 a 4, CLI y contrato de datos
```
